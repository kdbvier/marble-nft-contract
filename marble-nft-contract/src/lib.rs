...
impl Contract {
    ...
    #[payable]
    pub fn set_total_royalty(&mut self, total_royalty: u32) {
        assert_one_yocto();
        assert_eq!(
            env::predecessor_account_id(),
            self.tokens.owner_id,
        ...
        assert!(total_royalty <= 10000, "Royalty value can't exceed 100%.");
    ...
    pub fn nft_create_series(
        ...
        assert!(
            total_perpetual <= self.total_royalty,
            "Marble Exceeds maximum royalty",
        );
    ...
    #[payable]
    pub fn nft_remove_series(&mut self, token_series_id: TokenSeriesId) {
        assert_eq!(
            env::predecessor_account_id(),
            self.tokens.owner_id,
            "Marble: Owner Only"
    ...
    pub fn nft_decrease_series_copies(
        ...
        assert!(
            ...
            "Marble: cannot decrease supply, already minted : {}",
            minted_copies
        );
    ...
    pub fn get_total_royalty(self) -> u32 {
        let total_royalty = self.total_royalty;
        total_royalty
    }
    ...
    pub fn nft_token(&self, token_id: TokenId) -> Option<Token> {
        ...
        let series_metadata: TokenMetadata = match self.token_series_by_id.get(&token_series_id) {
            ...
            Some(token_serie) => token_serie.metadata,
        };
    ...
    pub fn nft_get_series_supply(&self) -> U128 {
...
mod tests {
    ...
    fn test_new() {
        ...
        assert_eq!(
            ...
            DATA_IMAGE_SVG_COMIC_ICON.to_string()
        );
    }
